...
install -p -D -m 644 %{SOURCE1} %{buildroot}%{_sysconfdir}/ceilometer/ceilometer.conf
install -p -D -m 644 etc/ceilometer/policy.json %{buildroot}%{_sysconfdir}/ceilometer/policy.json
install -p -D -m 644 etc/ceilometer/sources.json %{buildroot}%{_sysconfdir}/ceilometer/sources.json
install -p -D -m 644 %{SOURCE3} %{buildroot}%{_sysconfdir}/ceilometer/pipeline.yaml

# Install initscripts for services
install -p -D -m 644 %{SOURCE10} %{buildroot}/%{name}-api.service
install -p -D -m 644 %{SOURCE11} %{buildroot}/%{name}-collector.service
install -p -D -m 644 %{SOURCE13} %{buildroot}/%{name}-central.service
